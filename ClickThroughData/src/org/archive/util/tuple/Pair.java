...
public class Pair<FIRST, SECOND> implements PairInterface<FIRST, SECOND> {
	...
	public boolean equals(Object obj){
		...
		Pair<FIRST, SECOND> cmpPair = (Pair<FIRST, SECOND>)obj;
		//
		return null==this.first? null==cmpPair.first : this.first.equals(cmpPair.first) 
				&& null==this.second? null==cmpPair.second : this.second.equals(cmpPair.second);
	}
	/**
