...
public class LetterTokenizer_Var extends CharTokenizer {
   ...
   */
  public LetterTokenizer_Var(Version matchVersion, Reader in) {
   ...
   *          the input to split up into tokens
   */
  public LetterTokenizer_Var(Version matchVersion, AttributeFactory factory, Reader in) {
