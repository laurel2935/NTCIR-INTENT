...
import org.archive.ntcir.sm.similarity.editdistance.definition.Block;
import org.archive.ntcir.sm.similarity.editdistance.definition.ChunkEditUnit;
...
public class Split {
	...
	public static class LCS {
		public int length = 0;  //LCS匹配的最长结�?
		public int x_pos = 0;	//LCS匹配的X的位�?
		public int y_pos = 0;	//LCS匹配的Y的位�?
...
//		SuperString<CharEditUnit> ss2 = SuperString.createCharSuperString(s2);
		...
		//SuperString<TermEditUnit> ss1 = SuperString.createTermSuperString(s1);
		//SuperString<TermEditUnit> ss2 = SuperString.createTermSuperString(s2);
		//Split.split(ss1, ss2);
