...
import org.archive.ntcir.sm.similarity.hownet.sememe.LiuqunSememeParser;
...
public class LiuConceptParser extends BaseConceptParser{
    ...
    public static void main(String []args){
    	...
    	///*
    	try{
    		LiuConceptParser conceptParser = new LiuConceptParser();
    		Collection<Concept> concepts = conceptParser.getConcepts("游乐场");
    		int i=1;
    		for (Concept c : concepts) {
    			System.out.println("概念" + (i) + ": " + c.toString());  
    			System.out.println("概念" + (i) + ": " + c.toString2());
    			i++;
            }    		
    	}catch(Exception e){
    		e.printStackTrace();
    	...
    	String w1 = "歌词";
		String w2 = "伴奏";
		System.out.println(LiuConceptParser.getInstance().getSimilarity(w1, w2));
    }
