...
import org.archive.ml.clustering.ap.prime.PrimeAlgorithm;
import org.archive.ml.clustering.ap.prime.PrimeGraph;
...
public abstract class AffinityPropagationAlgorithm extends AbstractClusterAlgorithm<String> {
    ...
    /**
     * @return mapping style, from data-point to exemplar
     * **/
    ...
    /**
     * @return clustered style, from exemplar to the cluster
     * **/
...
//    protected abstract Double getSimilarity(String from, String to);
    ...
    /**
     * @return center assignments according to the similarity matrix S, i.e., the way as the original paper
     * **/
    private Map<Integer, ClusterInteger> computeOriginalAssignments(
    		Collection<Integer> examplars, Collection<Integer> centers) {
    	//
